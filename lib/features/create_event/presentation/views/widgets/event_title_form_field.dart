...
class EventTitleFormField extends StatelessWidget {
  const EventTitleFormField({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      controller: createEventController.eventTitleController,
      ...
      enabled: !createEventController.isLoading,
      maxLines: 1,
